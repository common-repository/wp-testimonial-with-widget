...
class Wtwp_Admin {
	...
	function wtwp_meta_box_content() {
		...
		if ( 0 < count( $field_data ) ) {
			...
			$html .= '<span class="description">' . __( 'Select testimonial rating.', 'wp-testimonial-with-widget' ) . '</span><strong>'.' '. sprintf( __( 'Try This <a href="%s" target="_blank">PRO Features in Essential Bundle Free For 5 Days.</a>', 'wp-testimonial-with-widget' ), WTWP_PLUGIN_LINK_UNLOCK);
			$html .= '</strong></td><tr/>' . "\n";
